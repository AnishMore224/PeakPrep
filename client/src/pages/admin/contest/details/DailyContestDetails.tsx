...
import QuestionsTab from "../../../../components/admin/contest/details/DailyContest/QuestionsTab";
import RankingsTab from "../../../../components/admin/contest/details/RankingsTab";
import SettingsTab from "../../../../components/admin/contest/details/DailyContest/SettingsTab";
...
function DailyContestDetails() {
  ...
  useEffect(() => {
    const fetchContest = async () => {
      const fetchedContest = await getContest(contestId, "DailyContest");
  ...
  const handleSettingsChange = (field: keyof DailyContestType, value: any) => {
    if (contest) {
      setContest((prev) => {
        if (!prev) return prev;
        return {
...
export default DailyContestDetails;
